    ...
    if (wishlist.length === 0) {
      ...
      `<div class='d-flex flex-column justify-content-center align-items-center'>
        ...
        <div class='text-center mt-2'>
          <a href='lista-licee.php' class='text-decoration-underline text-accent-3 heading-font'>Vezi liceele</a>
        </div>
      </div>`;
      return;
    }
          ...
          <div class="card border-0 rounded-4 overflow-hidden bg-white h-100 d-flex flex-column">
            <div class="row g-0 h-100">
              ...
              <div class="col-md-7 p-3 d-flex flex-column justify-content-between">
                ...
                <div>
                  <a class="btn bg-accent-3 text-white rounded-pill px-4 py-2 heading-font text-center text-lg-start mt-3" href="prezentare-liceu.php?liceu=${item.id}">Vezi detalii</a>
              ...
              <!-- Image -->
                <div class="col-md-5 d-flex align-items-stretch justify-content-center" style="background:#f8f9fa;">
                    <div class="w-100 h-100 d-flex align-items-stretch">
                        <img src="${item.image}" class="img-fluid rounded-end-4 object-fit-cover h-100 w-100" alt="Liceu" style="object-fit:cover; aspect-ratio:4/3;">
                    </div>
                </div>
            </div>
          </div>
